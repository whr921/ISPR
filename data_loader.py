...
from data_aug import ChannelAdap, ChannelAdapGray, ChannelRandomErasing, ChannelChoose, RandomErasing
import torchvision.transforms as transforms
import random
import math

class SYSUData(data.Dataset):
    def __init__(self, data_dir, args, transform=None, colorIndex=None, thermalIndex=None):
        # data_dir = '../vt_reid_model/data/SYSU-MM01/'
    ...
    def __getitem__(self, index):
        ...
        img_m = self.transform_color1(img1)
        img1 = self.transform_color(img1)
        img2 = self.transform_thermal(img2)

        return img_m, img1, img2, target1, target2
...
class RegDBData(data.Dataset):
    def __init__(self, data_dir, args, transform=None, colorIndex=None, thermalIndex=None):
        ...
        train_color_list = data_dir + 'idx/train_visible_{}'.format(args.trial) + '.txt'
        train_thermal_list = data_dir + 'idx/train_thermal_{}'.format(args.trial) + '.txt'
